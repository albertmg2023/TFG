...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  remappings = [('odom', '/robot/robotnik_base_controller/odometry')]
  if imu_used:
  ...
  nodes = [
    ...
    Node(
      ...
      remappings=remappings + [('scan_cloud', '/robot/top_3d_laser/scan/points')])
  ]
...
def generate_launch_description():
  return LaunchDescription([
    ...
    DeclareLaunchArgument(
      'frame_id', default_value='robot_base_link',
    ...
    DeclareLaunchArgument(
      'lidar_topic', default_value='/robot/top_3d_laser/scan/points',

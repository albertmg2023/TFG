...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  remappings = [('odom', '/rbwatcher/diffdrive_controller/odom')]
  if imu_used:
  ...
  nodes = [
    ...
    Node(
      ...
      remappings=remappings + [('scan_cloud', '/rbwatcher/rbwatcher/rbwatcher/top_3d_laser/point_cloud')])
  ]
...
def generate_launch_description():
  return LaunchDescription([
    ...
    DeclareLaunchArgument(
      'frame_id', default_value='rbwatcher/base_link',
    ...
    DeclareLaunchArgument(
      'lidar_topic', default_value='/rbwatcher/rbwatcher/rbwatcher/top_3d_laser/point_cloud',
